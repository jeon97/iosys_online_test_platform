...
수험표의 응시·면제 표시와 사진·약도 자료를 구성하는 [출력 구현 사례](docs/REPORT-PRESENTATION.md)를 추가하였습니다. AIDT 업무에서 작성한 [접근성·호환성 조사](docs/AIDT-COMPATIBILITY.md)는 실제 화면 테스트 결과와 구분하였습니다.
